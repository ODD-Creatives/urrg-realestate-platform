        ...
        <div class="row gy-30 align-items-center justify-content-center ps-md-5 pe-md-5">
            <div class="col-xl-6 col-lg-6 col-md-6 fadeinup wow">
                <div class="why-card-1 style-2">
                    <div class="hover-icon"><img src="{{ assassets/img/icon/why-hover-icon-1.png" alt="img"></div>
...
<div class="brand-area-1 overflow-hidden">
    <div class="row align-items-center justify-content-center mt-30 ps-2 pe-2">
        <div class="col-xl-6 text-center">
            <p class="sub-title fadeinup wow" data-wow-duration="1.5s" data-wow-delay="0.1s">
                <span class="double-line"></span> Verified Partnerships
            </p>
            <p class="sec-text fadeinup wow" data-wow-duration="1.5s" data-wow-delay="0.3s">
            ...
            <div class="col-lg-10">
                <div class="swiper th-slider" id="brand-slider-1"
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="brand-box"><a href="about.html"><img src="assets/img/brand/brand_1_6.svg"
                                        alt="Brand Logo"></a></div>
                        </div>
                        <div class="swiper-slide">
                            <div class="brand-box"><a href="about.html"><img src="assets/img/brand/brand_1_1.svg"
