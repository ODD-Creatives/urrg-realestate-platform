<div class="about-1-wrapper space overflow-hidden" id="about-sec">
    <div class="shape-mockup" data-bottom="0" data-left="0"><img src="{{ asset('assets/img/icon/about-2-shape.png')}}" alt="img">
    </div>
    <div class="shape-mockup spin d-none d-lg-block" data-bottom="11%" data-left="5%"><img
            src="{{ asset('assets/img/icon/circle-start1.png')}}" alt="img"></div>
    <div class="container">
            ...
            <div class="col-xl-6">
                <div class="img-box1 about-1 fadeinup wow" data-wow-duration="1.5s" data-wow-delay="0.3s">
                    ...
                    <div class="about-middle">
                        <img class="tilt-active" src="{{ asset('assets/img/about/about-1-middle1.jpg')}}"
                            alt="Image"></div>
